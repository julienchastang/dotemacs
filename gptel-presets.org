...
#+begin_src emacs-lisp
  (add-to-list 'load-path "~/.emacs.d/git/gptel/")

  (unless (file-exists-p "~/.emacs.d/git/gptel/gptel-autoloads.el")
    (package-generate-autoloads "gptel" "~/.emacs.d/git/gptel/"))

  (load "~/.emacs.d/git/gptel/gptel-autoloads.el")
  (require 'gptel)
#+end_src
